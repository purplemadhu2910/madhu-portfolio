...
const projects = [
  ...
  },
  {
    ...
    highlights: [
      'TF-IDF Vectorization & Cosine Similarity for keyword scoring',
      'Automated skill extraction & gap analysis against job descriptions',
      'Interactive circular score visualization & feedback dashboard',
      'Full drag-and-drop upload supporting multiple file formats'
    ],
  ...
  },
  {
    ...
    highlights: [
      'Evaluated Random Forest, Decision Trees & XGBoost classifiers',
      'SMOTE oversampling for imbalanced financial dataset handling',
      'Interactive Streamlit web application for real-time risk scoring',
      'Detailed feature importance visualization for financial security insights'
    ],
  ...
  },
  {
    ...
    highlights: [
      'Extracts 21 3D hand landmark coordinates using Google MediaPipe',
      'Custom Random Forest classifier predicting ASL alphabets in real time',
      'High accuracy computer vision pipeline processing 30+ FPS webcam stream',
      'SQLite database storing gesture history and user logs'
    ],
  ...
  },
  {
    ...
    highlights: [
      'Finger-tracking gesture pen interface via OpenCV & MediaPipe',
      'Deep Learning CNN trained on handwritten math symbols dataset',
      'Evaluates complex mathematical expressions on the fly',
      'Virtual canvas clear and undo gestures'
    ],
  ...
  },
  {
    ...
    highlights: [
      'Step-by-step animation of sorting algorithms with array bar updates',
      'Speed & array size adjustment sliders',
      'Includes Bubble Sort, Quick Sort, Merge Sort & Binary Search',
      'Clean responsive React interface with real-time comparison counts'
    ],
  ...
  },
  {
    ...
    highlights: [
      'Exploratory Data Analysis (EDA) on multi-year weather dataset',
      'Feature engineering & correlation heatmap analysis',
      'Model performance comparison across Linear Regression, Random Forest & XGBoost',
      'Interactive plots for rainfall trend analysis'
    ],
